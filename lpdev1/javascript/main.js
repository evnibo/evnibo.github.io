...
;(function($) {
   ...
   'use strict'
    ...
    var ajaxSubscribe = {
        obj: {
            subscribeEmail    : $('#subscribe-email222'),
            subscribeButton   : $('#subscribe-button222'),
            subscribeMsg      : $('#subscribe-msg222'),
            subscribeContent  : $("#subscribe-content222"),
            dataMailchimp     : $('#subscribe-form222').attr('data-mailchimp222'),
